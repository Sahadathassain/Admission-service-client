      ...
      <div  className="w-full max-w-md bg-white  rounded p-8">
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-center">
            <button
              type="submit"
              className="w-full text-xl bg-gradient-to-r from-[#76BA99] to-amber-600 hover:from-purple-600 hover:to-yellow-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-pink-500">
              Sign In
            </button>
          </div>
        </form>
        <p className="text-[#76BA99] mt-4 text-center">
          Do not have an account?{" "}
          <Link
            to="/register"
            className="text-[#76BA99] text-2xl font-bold underline">
            Register
          </Link>
        </p>
        <div className="mt-6">
